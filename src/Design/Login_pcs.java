...
public class Login_pcs extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_username_pcs = new javax.swing.JTextField();
        txt_password_pcs = new javax.swing.JPasswordField();
        CheckBox = new javax.swing.JCheckBox();
        login_pcs = new javax.swing.JButton();
        ...
        login_pcs.setBackground(new java.awt.Color(255, 102, 0));
        login_pcs.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        login_pcs.setForeground(new java.awt.Color(51, 0, 51));
        login_pcs.setText("Login");
        login_pcs.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                login_pcsActionPerformed(evt);
            }
        });
        jPanel2.add(login_pcs, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 310, 140, 40));
    ...
    private void txt_username_pcsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_username_pcsActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_username_pcsActionPerformed

    private void CheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckBoxActionPerformed
        if (CheckBox.isSelected()) {
            txt_password_pcs.setEchoChar((char) 0);

        }
        else{
            txt_password_pcs.setEchoChar('*');
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Login_pcs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton login_pcs;
    private javax.swing.JPasswordField txt_password_pcs;
    private javax.swing.JTextField txt_username_pcs;
